...
<body>
    ...
    <div class="grid grid-cols-5 bg-[#FFFFFF] grid-row-4">
        ...
        <div class="col-start-2 my-[2.36rem] mx-[3rem] col-span-4 bg-[#FFFFFF] py-[2.81rem] px-[2.84rem] mt-[2.38rem]" style="background-size: contain;">
            <div>
                <h1 class="text-2xl uppercase font-bold cabin" style="color: black;">Employee List</h1>
                        ...
                        @foreach ($employees as $employee)
                            <div class="flex space-x-4" onclick="selectedID(this, '{{ $employee->id }}')">
                                ...
                                <div class="flex flex-col justify-center items-center">
                                    <a href="{{ route('employees.assign-designation.create', ['emp_num' => $employee->emp_num]) }}" class="bg-[#292E37] hover:bg-[#15151D] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex-shrink">
                                ...
                                <div class="flex flex-col justify-center items-center">
                                    <a href="{{ route('employees.edit', $employee->id) }}" class="bg-[#292E37] hover:bg-[#15151D] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex-shrink">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
