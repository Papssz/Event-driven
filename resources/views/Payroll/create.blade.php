        ...
        <div class="col-start-2 my-[2.36rem] mx-[3rem] col-span-4 bg-[#FFFFFF] py-[2.81rem] px-[2.84rem] mt-[2.38rem]" style="background-size: contain;">
            ...
            <div class="rounded-t bg-[#292E37] mb-0 px-6 py-6">
                <div class="text-center flex justify-between">
                    <h6 class="text-blueGray-700 text-xl font-bold uppercase text-white cabin">Generate Payroll</h6>
                </div>
            </div>
            <div class="flex-auto px-4 lg:px-10 py-10 pt-0 border border-[#15151D] rounded-b">
                <form action="{{ route('payroll.store') }}" method="POST">
                    ...
                    <h6 class="text-blueGray-400 text-sm mt-6 mb-6 font-bold uppercase">Employee Name</h6>
                    <div class="mt-3 mb-6"></div>
                    
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/4 px-4">
                            <div class="relative w-full mb-3">
                                <select id="employee_id" name="employee_id" class="border-0 px-3 py-3 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-gray-500">
                                    <option value=""></option>
                    ...
                    <h6 class="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">Start of Cutoff</h6>

                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/4 px-4">
                            <div class="relative w-full mb-3">
                                <input type="date" class="form-control" id="start_of_cutoff" name="start_of_cutoff" class="border-0 px-3 py-3 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-gray-500">
                            </div>
                        </div>
                    </div>

                    <hr class="mt-6 border-b-1 border-blueGray-300">
                    <h6 class="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">End of Cutoff</h6>

                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/4 px-4">
                            <div class="relative w-full mb-3">
                                <input type="date" class="form-control" id="end_of_cutoff" name="end_of_cutoff" class="border-0 px-3 py-3 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-gray-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row justify-end gap-2.5 mt-[1.12rem]">
                        <button type="submit" class="buttonFormat border rounded-md border-black bg-[#292E37] text-white hover:bg-[#15151D] text-black hover:text-white font-bold py-3 px-5">GENERATE PAYROLL</button>
                    </div>
