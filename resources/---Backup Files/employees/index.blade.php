                        ...
                        <div class="flex flex-col gap-4" >
                            ...
                            @foreach ($employees as $employee)
                                    ...
                                    <form action="{{ route('employees.destroy', $employee->id) }}" method="POST" class="flex flex-col justify-center items-center">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-gray-400 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex-shrink" onclick=>
                                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
